...
import 'schema/drives_record.dart';
...
export 'schema/drives_record.dart';
...
/// Functions to query DrivesRecords (as a Stream and as a Future).
Stream<List<DrivesRecord>> queryDrivesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DrivesRecord.collection,
...
Future<List<DrivesRecord>> queryDrivesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<DrivesRecord>> queryDrivesRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
