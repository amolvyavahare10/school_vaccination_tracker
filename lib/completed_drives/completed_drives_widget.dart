...
class CompletedDrivesWidget extends StatefulWidget {
  const CompletedDrivesWidget({Key? key}) : super(key: key);

  @override
  _CompletedDrivesWidgetState createState() => _CompletedDrivesWidgetState();
}

class _CompletedDrivesWidgetState extends State<CompletedDrivesWidget>
                ...
                child: PagedListView<DocumentSnapshot<Object?>?, DrivesRecord>(
                  pagingController: () {
                    final Query<Object?> Function(Query<Object?>) queryBuilder =
                        (drivesRecord) =>
                            drivesRecord.where('driveState', isEqualTo: true);
